...
**Example**: The app icon (`docs/icon/`) uses layered vector SVGs in Icon Composer with system-provided glass effects, per HIG "App icons". The menu bar extra is a menu, not a popover (HIG "The menu bar"); the Mini Player follows Music's MiniPlayer.
